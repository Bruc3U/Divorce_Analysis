...
"""
#Divorce Prediction Project Code: 
...
os.chdir(r'C:\Users\98yan\OneDrive\Documents\Yanis\Professionel\Portfolio\divorce')
os.getcwd()
...
#data seems clean, no NaaN values 
...
#logistic regression seems to be accurate
#Too many Xs might overfit the data

#Using the PCA will reduce the amount of Xs
#Elbow Point Method to find the correct amount of components
...
#visualize the number of optmized components
...
#2 as advised by the shoulder methods see above
n_components = 2
...
#logistic regression with reduced Xs
